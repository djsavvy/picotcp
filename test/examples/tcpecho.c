#include "lib/picotcp/build/include/pico_addressing.h"
#include "lib/picotcp/build/include/pico_ipv4.h"
#include "lib/picotcp/build/include/pico_queue.h"
#include "lib/picotcp/build/include/pico_socket.h"
#include "lib/picotcp/build/include/pico_stack.h"
#include "lib/picotcp/build/include/pico_tcp.h"
#include "lib/picotcp/build/include/pico_tree.h"
...
void cb_tcpecho(uint16_t ev, struct pico_socket *s) {
  ...
  if (ev & PICO_SOCK_EV_RD) {
    if (flag & PICO_SOCK_EV_CLOSE) printf("SOCKET> EV_RD, FIN RECEIVED\n");
...
out:
  fprintf(stderr,
          "tcpecho expects the following format: tcpecho:listen_port\n");
  exit(255);
}
/*** END TCP ECHO ***/
